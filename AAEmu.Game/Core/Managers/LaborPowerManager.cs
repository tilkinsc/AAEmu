...
namespace AAEmu.Game.Core.Managers
{
    public class LaborPowerManager : Singleton<LaborPowerManager>
    {
        ...
        public void Initialize()
        {
            ...
            _log.Info("Fremium max labor: {0}", _labor["fremium_maximum_labor"]);
            _log.Info("Premium max labor: {0}", _labor["premium_maximum_labor"]);
            ...
            foreach (var connection in connections)
            {
                foreach (var character in connection.Characters)
                {
                    ...
                    if (payment == PaymentMethodType.None) {
                        ...
                        up_limit = _labor["fremium_maximum_labor"];
                    ...
                    else if (payment == PaymentMethodType.Premium)
                    {
                        ...
                        up_limit = _labor["premium_maximum_labor"];
